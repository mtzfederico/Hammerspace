...
func TestIsUserIDValid(t *testing.T) {
	items := map[string]bool{"bob": false, "1234": false, "12345": true, "myUser0": true, "sample_user": true, "john.doe": true, "noobMaster69": true, "first-last": true, "user@name": false, "user;name": false, "user,name": false, "😀": false, "aioh 😀": false, "thisUsernameIsWayTooLong": false, "UserName' drop table users; --": false}
...
func TestIsEmailValid(t *testing.T) {
	items := map[string]bool{"me@example.com": true, "hello.world@example.com": true, "defenitelyNotAnEmail.com": false, "@username": false, "": false, "noobMaster69": false, "first-last": false, "user;name": false, "email' drop table users; --": false}
